...
<script id="action_tpl" type="text/x-handlebars-template">
    <div class="btn-group">
        <button type="button" class="btn btn-success btn-xs"
                onclick="window.location.href=g.ctx + '/admin/member/driver/capitalpage/{{d.id}}-${id1}'">查看详情
        </button>
    </div>
</script>
...
<script type="text/javascript" src="${ctx}/static/js/app/admin/drivercapital.js?_${.now?string("hhmmss")}"></script>
</#macro>