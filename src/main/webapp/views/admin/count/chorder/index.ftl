...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="table-responsive" style="overflow: auto;">
            <form class="form-inline" id="SearchForm" method="get" action="${ctx}/admin/count/chorder">
...
<script type="text/javascript">
    function dataExport() {
        excelExport.Export("companyRebate-list1","导出表格",'出租车统计.xls');
    }
</script>
</#macro>