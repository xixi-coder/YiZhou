...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <div class="table-responsive">
            <form class="form-inline" id="SearchForm" method="get" action="${ctx}/admin/count/zhorder">
...
<script type="text/javascript">
    function dataExport() {
        excelExport.Export("companyRebate-list1","导出表格",'专车订单统计.xls');
    }
</script>
</#macro>