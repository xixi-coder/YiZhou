...
<div class="panel panel-default">
    ...
    <div class="panel-body">
        <form class="form-inline" id="SearchForm" method="get" action="${ctx}/admin/count/zxorder">
        ...
        <div class="table-responsive">
            <table id="companyRebate-list1" cellspacing="0" class="hover table table-striped table-bordered"
                ...
                <tr style="font-size:14px;">
                    ...
                    "" colspan="9"><b>专线订单汇总统计</b></span></th>
                </tr>
                </thead>
                <tbody>
                <tr>
...
<script type="text/javascript">
    function dataExport() {
        excelExport.Export("companyRebate-list1","导出表格","快车订单统计.xls");
    }
</script>
</#macro>